  ...
  componentWillMount() {
    fetch(ip + "/chatFetch/", {
      ...
      .then(response => {
        ...
        this.setState({ wsToken:obj["wsToken"]["token"], availableGroups:obj["availableGroups"], yourGroups:obj["userGroups"]});
        this.sort(obj)
  ...
  render(){
    return(
      ...
      >
        ...
        {this.state.yourGroups==""? (<Text style={{
            paddingLeft: 15,
            paddingTop: 8,
            paddingBottom: 2,
            fontSize: 15,
            color: "black"
          }}>You are not a member of any group yet!</Text>) :(this.state.yourGroups.map((l, i) => (
          <TouchableOpacity
            onPress={() => {
        ...
        {this.state.yourChats==""? (<Text style={{
            paddingLeft: 15,
            paddingTop: 8,
            paddingBottom: 2,
            fontSize: 15,
            color: "black"
          }}>You do not have any chats yet!</Text>) :(this.state.yourChats.map((l, i) => (
          <TouchableOpacity
            onPress={() => {
              this.props.screenProps.rootNavigation.navigate("GroupPage", {
                obj: l,
        ...
        {this.state.availableGroups==""? (<Text style={{
            paddingLeft: 15,
            paddingTop: 8,
            paddingBottom: 2,
            fontSize: 15,
            color: "black"
          }}>There are no groups to join at the moment!</Text>) : (this.state.availableGroups.map((l, i) => (
          <TouchableOpacity
            onPress={() => {
              fetch(ip + "/joinGroup/", {
                method: "post",
        ...
        {this.state.yourFriends==""? (<Text style={{
            paddingLeft: 15,
            paddingTop: 8,
            paddingBottom: 2,
            fontSize: 15,
            color: "black"
          }}>Please add some friends!</Text>) :(this.state.yourFriends.map((l, i) => (
          <TouchableOpacity
            onPress={() => {
              this.props.screenProps.rootNavigation.navigate("GroupPage", {
                obj: l,
