...
export class Profile extends Component {
  ...
  _onRefresh = () => {
    ...
    fetch("http://192.168.43.18:8000/getProfileView/", {
      method: "get",
      headers: {
                  ...
                  >
                    ...
                    {item.profilePic ? (
                      <Image
                        ...
                        source={{
                          uri: "http://192.168.43.18:8000" + item.profilePic
                        }}
                      />
                    ) : (
                      <Image
                  ...
                  if (item.image != null) {
                    image = (
                      <Image
                        ...
                        source={{
                          uri: "http://192.168.43.18:8000" + item.image.toString()
                        }}
                      />
                    );
                  } else {
...
export class Groups extends Component {
  ...
  _onRefresh = () => {
    this.setState({ refreshing: true });
    fetch("http://192.168.43.18:8000/groups/", {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
    ...
    return (
      ...
      refreshControl={
          ...
          >
            {l.image ? (
              <ListItem
                key={i}
                avatar={{
                  uri: "http://192.168.43.18:8000" + l.image
                }}
                title={l.title}
        ...
        {this.state.data1.map((l, i) => (
          <TouchableOpacity
            onPress={() => {
              fetch("http://192.168.43.18:8000/joinGroup/", {
                method: "post",
                headers: {
                  Accept: "application/json",
                  "Content-Type": "application/json",
...
export class Feed extends Component {
  ...
  _onRefresh = () => {
    this.setState({ refreshing: true });
    fetch("http://192.168.43.18:8000/feed/", {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Button
                        ...
                        onPress={() => {
                          ...
                          fetch("http://192.168.43.18:8000/send-response/", {
                            method: "post",
                            headers: {
...
export default class Home extends Component {
  ...
  componentDidMount() {
    ...
    fetch("http://192.168.43.18:8000/profile.json", {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
