...
class CustomUser(AbstractUser):
    ...
    education = models.CharField(max_length=30, unique=False, default="", editable=True,null=True)
    adhaarNo = models.CharField(max_length=16, unique=False, default="", editable=True,null=True)
    profession = models.CharField(max_length=30, unique=False, default="", editable=True,null=True)
    emergencyContact = models.IntegerField(default=0, editable=True)
    officeAddress = models.CharField(max_length=100, default="", editable=True,null=True)
